<?php
/**
 * User Layout - Clean, Simple Layout for User Dashboard
...
<head>
    ...
    <title><?php echo isset($pageTitle) ? $pageTitle . ' - SmartPicks Pro' : 'SmartPicks Pro'; ?></title>
    ...
    <style>
        * {
        ...
        .btn-mark-all:hover, .btn-view-all:hover {
            background: #e0e0e0;
        }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            <?php include __DIR__ . '/../components/user_menu.php'; ?>
        </nav>
    </div>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="user-info">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown" style="display: none;">
                        <div class="notification-header">
                            ...
                            <div class="notification-actions">
                                ...
                                <a href="<?php echo isset($baseUrl) ? $baseUrl : ''; ?>/notifications" class="btn-view-all">View all</a>
                            </div>
                        </div>
                        ...
                        <div class="notification-footer">
                            <a href="<?php echo isset($baseUrl) ? $baseUrl : ''; ?>/notifications">View all notifications</a>
                        </div>
                    </div>
                </div>
                <div class="user-avatar">
                    ...
                    if (isset($user)) {
                        $usernameInitial = strtoupper(substr($user['username'] ?? 'U', 0, 1));
        ...
        <div class="footer">
            <p>&copy; <?php echo date('Y'); ?> SmartPicks Pro. All rights reserved.</p>
        </div>
    </div>
