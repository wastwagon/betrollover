      ...
      <div className={`flex flex-col ${compact ? 'gap-2.5' : 'gap-3'} min-w-0`}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-2 text-xs font-semibold text-emerald-800 dark:text-emerald-300 hover:bg-emerald-500/15 transition-colors"
          >
