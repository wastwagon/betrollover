...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Definitions for purchase protection, ROI, win rate, and settlement on BetRollover. How-to pages live under Guides; match stories live under News.',
    alternates: seoAlternates('/learn', locale),
    openGraph: {
      url: localizedUrl('/learn', locale),
      title: 'Tipster Marketplace Glossary',
      description:
        'Purchase protection, ROI, win rate, and settlement terms. Educational copy — not betting advice.',
    },
  };
}
...
export default async function LearnLayout({ children }: { children: React.ReactNode }) {
  ...
  const learnPageJsonLd = {
    ...
    description:
      'Glossary of purchase protection, ROI, win rate, and settlement on the BetRollover marketplace.',
    url: pageUrl,
    publisher: {
      '@type': 'Organization',
      name: SITE_NAME,
