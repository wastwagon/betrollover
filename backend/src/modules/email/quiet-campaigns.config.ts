...
export const QUIET_STEPS: QuietStep[] = [
  ...
  },
  {
    ...
    subject: 'Two-fold shorts from Acca Desk',
    eyebrow: 'Acca Desk',
    title: 'Short lists, two legs',
    body: 'Acca Desk posts Over 1.5 and Over 2.5 2-folds. Follow a tipster for those shorts. Educational tool — not a guarantee. 18+.',
