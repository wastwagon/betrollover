 ...
 * Relaxed: weekly tipsters 0.58–0.60 prob; no fixture_days; single-league + 'All'.
 */
...
export const AI_TIPSTERS: AiTipsterConfig[] = [
  ...
  // ============================================
  {
    ...
    personality: {
      ...
      leagues_focus: ['Premier League', 'La Liga', 'All'],
  ...
  },
  {
    ...
    personality: {
      ...
      min_expected_value: 0.05,
      min_api_confidence: 0.52,
      leagues_focus: ['Premier League', 'All'],
  ...
  },
  {
    ...
    personality: {
      ...
      min_expected_value: 0.05,
      min_api_confidence: 0.52,
      leagues_focus: ['Premier League', 'Bundesliga', 'Serie A', 'All'],
      bet_types: ['Over 2.5'],
      max_daily_predictions: 5,
    },
  },
  {
    ...
    bio: 'Under 2.5 goals specialist. Same value pool as The Gambler; under 2.5 only.',
  ...
  },
  {
    ...
    personality: {
      ...
      min_expected_value: 0.04,
      min_api_confidence: 0.5,
      leagues_focus: ['Championship', 'All'],
      bet_types: ['1X2', 'BTTS'],
      max_daily_predictions: 5,
    },
  },
  ...
  },
  {
    ...
    bio: '1–2 picks daily when value appears. 1X2, BTTS, Under 2.5. All leagues.',
