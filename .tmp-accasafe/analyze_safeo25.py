...
FILES = [
    "AccaSafeO25-2026-08-14.json",
    "AccaSafeO25-2026-08-21.json",
    "AccaSafeO25-2026-08-28.json",
    "AccaSafeO25-2026-09-04.json",
    "AccaSafeO25-2026-09-11.json",
]
...
def main():
    ...
    cf(lambda t: slot_from_title(t.get("title") or "") == "Afternoon", "Afternoon only")
    cf(lambda t: slot_from_title(t.get("title") or "") in ("Early", "Afternoon"), "Early+Afternoon")
    cf(lambda t: slot_from_title(t.get("title") or "") == "Early" and not youth(t), "Early no youth")
